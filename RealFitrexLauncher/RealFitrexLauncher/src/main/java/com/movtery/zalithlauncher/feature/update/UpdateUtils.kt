...
class UpdateUtils {
    companion object {
        ...
        fun getDownloadUrl(launcherVersion: LauncherVersion): String {
            ...
            return "https://github.com/RealFitrexLauncher/RealFitrexLauncher/releases/download/" +
                    "${launcherVersion.versionCode}/RealFitrexLauncher-${launcherVersion.versionName}" +
